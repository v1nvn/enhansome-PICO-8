...
A curated list of PICO-8 resources, tutorials, tools and more. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 465,428 | 🐛 73 | 📅 2026-05-05 list thing. You might also like [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,499 | 🐛 47 | 📅 2024-08-11 and [awesome-love2d](https://github.com/JanWerder/awesome-love2d) ⭐ 4,348 | 🐛 3 | 🌐 PowerShell | 📅 2026-04-07.
...
* [picotool](https://github.com/dansanderson/picotool) ⭐ 402 | 🐛 53 | 🌐 Python | 📅 2024-02-03 -  Tools and Python libraries for manipulating Pico-8 game files.
...
* [Shrinko8](https://github.com/thisismypassport/shrinko8) ⭐ 163 | 🐛 9 | 🌐 Lua | 📅 2026-02-10 - A minifier that aggressively shrinks Pico-8 code size. Also includes a linter and other tools.
* [P8Coder](https://github.com/movAX13h/P8Coder) ⭐ 109 | 🐛 3 | 🌐 C# | 📅 2025-07-22 - A programming tool that replaces the lua code in pico-8 cartridges (p8) with the code you write in P8Coder.
* [midi2pico](https://github.com/gamax92/midi2pico) ⭐ 70 | 🐛 1 | 🌐 Lua | 📅 2020-01-17 - A MIDI to PICO-8 converter.
* [jspicl](https://github.com/jspicl/jspicl) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-24 - Write PICO-8 games in JavaScript or TypeScript, with live reloading so you can see your changes instantly!
...
* [SCUMM-8](https://github.com/Liquidream/scumm-8) ⭐ 355 | 🐛 2 | 🌐 Lua | 📅 2025-08-11 - De-make of the SCUMM engine for making point-and-click classic adventures.
...
* Visual Studio Code: [pico8-ls](https://github.com/japhib/pico8-ls) ⭐ 111 | 🐛 31 | 🌐 TypeScript | 📅 2025-09-23 - PICO-8 Language Server, providing full language support for the PICO-8 dialect of Lua.
* Vim: [vim-pico8-syntax](https://github.com/justinj/vim-pico8-syntax) ⭐ 65 | 🐛 5 | 🌐 VimL | 📅 2017-09-17
* Visual Studio Code / NeoVim / JetBrains / Others： [pico8-definitions](https://github.com/ahai64/pico8-definitions) ⭐ 34 | 🐛 0 | 🌐 Lua | 📅 2025-11-12 - An add-on for sumneko/lua to provide PICO-8 language support.
...
You might be interested to install [pico-8 programming fonts](https://github.com/juanitogan/p8-programming-fonts) ⭐ 122 | 🐛 0 | 📅 2020-05-19 they support the pico-8 custom characters as well as various fonts (bitmap and regular anti-aliased fonts). Check the [BBS thread here](https://www.lexaloffle.com/bbs/?tid=28975).
...
* [GameShell](https://www.clockworkpi.com/) - A modular handheld game console that allows you to play & modify retro games and DIY new devices. Check the [GameShell Docs](https://github.com/clockworkpi/GameShellDocs/wiki/Running-PICO-8-on-the-GameShell) ⭐ 191 | 🐛 5 | 📅 2021-08-15 for how to run PICO-8 on the GameShell.
...
* [PicoLove](https://github.com/picolove/picolove) ⭐ 880 | 🐛 17 | 🌐 Lua | 📅 2024-10-24 - Pico-8 Reimplementation in LÖVE.
