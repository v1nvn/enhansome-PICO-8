...
A curated list of PICO-8 resources, tutorials, tools and more. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 474,097 | 🐛 82 | 📅 2026-06-02 list thing. You might also like [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,509 | 🐛 47 | 📅 2024-08-11 and [awesome-love2d](https://github.com/JanWerder/awesome-love2d) ⭐ 4,391 | 🐛 0 | 🌐 PowerShell | 📅 2026-05-26.
...
* [Shrinko8](https://github.com/thisismypassport/shrinko8) ⭐ 168 | 🐛 9 | 🌐 Lua | 📅 2026-02-10 - A minifier that aggressively shrinks Pico-8 code size. Also includes a linter and other tools.
...
* [jspicl](https://github.com/jspicl/jspicl) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2026-06-08 - Write PICO-8 games in JavaScript or TypeScript, with live reloading so you can see your changes instantly!
...
* [PicoLove](https://github.com/picolove/picolove) ⭐ 883 | 🐛 17 | 🌐 Lua | 📅 2024-10-24 - Pico-8 Reimplementation in LÖVE.
