...
A curated list of PICO-8 resources, tutorials, tools and more. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28 list thing. You might also like [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,455 | 🐛 47 | 📅 2024-08-11 and [awesome-love2d](https://github.com/JanWerder/awesome-love2d) ⭐ 4,213 | 🐛 0 | 🌐 PowerShell | 📅 2026-01-29.
...
* [Shrinko8](https://github.com/thisismypassport/shrinko8) ⭐ 149 | 🐛 9 | 🌐 Lua | 📅 2025-11-21 - A minifier that aggressively shrinks Pico-8 code size. Also includes a linter and other tools.
