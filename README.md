...
A curated list of PICO-8 resources, tutorials, tools and more. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 444,205 | 🐛 75 | 📅 2026-03-09 list thing. You might also like [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,476 | 🐛 47 | 📅 2024-08-11 and [awesome-love2d](https://github.com/JanWerder/awesome-love2d) ⭐ 4,255 | 🐛 3 | 🌐 PowerShell | 📅 2026-01-29.
...
* [picotool](https://github.com/dansanderson/picotool) ⭐ 398 | 🐛 53 | 🌐 Python | 📅 2024-02-03 -  Tools and Python libraries for manipulating Pico-8 game files.
...
* [Shrinko8](https://github.com/thisismypassport/shrinko8) ⭐ 151 | 🐛 8 | 🌐 Lua | 📅 2026-02-10 - A minifier that aggressively shrinks Pico-8 code size. Also includes a linter and other tools.
...
* [jspicl](https://github.com/jspicl/jspicl) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-10 - Write PICO-8 games in JavaScript or TypeScript, with live reloading so you can see your changes instantly!
...
* Visual Studio Code: [pico8-ls](https://github.com/japhib/pico8-ls) ⭐ 108 | 🐛 31 | 🌐 TypeScript | 📅 2025-09-23 - PICO-8 Language Server, providing full language support for the PICO-8 dialect of Lua.
...
* [PicoLove](https://github.com/picolove/picolove) ⭐ 873 | 🐛 17 | 🌐 Lua | 📅 2024-10-24 - Pico-8 Reimplementation in LÖVE.
